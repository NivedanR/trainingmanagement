...
import com.example.vendorservice.dao.entity.ContactPerson;
...
public class Vendordto {
    ...
    public Vendordto(Long id, String name, String contactno, String website, String email, String GSTpin, String CIN, String headOffice, List<ContactPerson> poc) {
        this.id = id;
        this.name = name;
